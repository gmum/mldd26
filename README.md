# Machine Learning in Drug Design (2026)
...
2. Download this repository: `git clone https://github.com/gmum/mldd26.git`.
...
Credits to [Tomasz Danel ](https://scholar.google.com/citations?user=WZq_OCsAAAAJ&hl=pl) for materials. 